...
{% raw %}
  createpullsecret:
    ...
    stage: deploy
    commands:
    - codefresh generate image-pull-secret --cluster '[CLUSTER_NAME]' --namespace --registry myazureregistry
{% endraw %}
```
...
{% raw %}
  deploy:
    ...
    environment:
      ...
      - CUSTOM_deployment[0].image.pullSecret=codefresh-generated-r.cfcr.io-cfcr-default
{% endraw %}
```

You can find more information in the [Helm documentation page](https://codefresh.io/docs/docs/new-helm/using-helm-in-codefresh-pipeline/)
...
You should replace `akschallengeXXXXXXXX` with your own Azure registry name and `akschallenge@CloudLabs M12VC - XXX` with your own cluster name
as shown in Codefresh integrations.
