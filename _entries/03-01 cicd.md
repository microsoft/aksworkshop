...
#### Enable the new multistage pipeline experience (Preview)
...
> **Important** For the pipeline to work, you should make sure to change the value of the `imageRepository` in the pipeline to match your `deployment.yaml` file. For example: `uniqueacrname.azurecr.io/captureorder`.
